        ...
        <colorrampshader minimumValue="1" labelPrecision="0" maximumValue="4" colorRampType="DISCRETE" classificationMode="1" clip="0">
          <colorramp name="[source]" type="gradient">
            <Option type="Map">
              ...
              <Option name="stops" type="QString" value="0;56,167,0,255:0.333333;176,224,0,255:0.666667;255,170,0,255"/>
            </Option>
            <prop k="color1" v="255,0,255,0"/>
            <prop k="color2" v="255,0,0,255"/>
            <prop k="discrete" v="0"/>
            <prop k="rampType" v="gradient"/>
            <prop k="stops" v="0;56,167,0,255:0.333333;176,224,0,255:0.666667;255,170,0,255"/>
          </colorramp>
          <item alpha="0" label="&lt;= 0" value="0" color="#ff00ff"/>
          <item alpha="255" label="最适宜区" value="1" color="#38a700"/>
          <item alpha="255" label="适宜区" value="2" color="#b0e000"/>
          <item alpha="255" label="次适宜区" value="3" color="#ffaa00"/>
          <item alpha="255" label="不适宜区" value="4" color="#ff0000"/>
