...
class BaseConfig:
    ...
    def get_config(self, config_key: str, crop_code: str, zoning_type: str) -> Dict[str, Any]:
        """获取配置参数 - 支持通过配置键直接获取"""
        ...
        if config_file.exists():
            ...
            fallback_key = f"zoning_{config_key.split('_')[1]}_{crop_code}_{zoning_type}"
    ...
    def merge_configs(self, user_config: Dict[str, Any], 
                     config_key: str, crop_code: str, zoning_type: str) -> Dict[str, Any]:
        """合并用户配置和默认配置"""
        default_config = self.get_config(config_key, crop_code, zoning_type)
    ...
    # def get_config(self, area_code: str, crop_code: str, zoning_type: str) -> Dict[str, Any]:
    #     """获取配置参数"""
    #     config_key = f"zoning_{area_code}_{crop_code}_{zoning_type}"
    ...
    # def merge_configs(self, user_config: Dict[str, Any], 
    #                  area_code: str, crop_code: str, zoning_type: str) -> Dict[str, Any]:
    #     """合并用户配置和默认配置"""
    #     default_config = self.get_config(area_code, crop_code, zoning_type)
