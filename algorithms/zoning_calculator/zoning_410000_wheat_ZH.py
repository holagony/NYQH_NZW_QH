...
class WheatDisasterZoning:
    ...
    def calculate(self, params):
        ...
        if disaster_type == 'wheat_continuous_rain':
            return self._calculate_continuous_rain(params)
        else:
            raise ValueError(f"不支持的灾害类型: {disaster_type}")
    
    def _calculate_continuous_rain(self, params):
    ...
    def _calculate_continuous_rain_indicators_station(self, station_indicators,params):
        ...
        for station_id, indicators in station_indicators.items():
            ...
            continuous_rain_indicators[station_id] = weighted_frequency
